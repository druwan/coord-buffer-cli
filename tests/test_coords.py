...
from src.coords import dms_to_dd_coords, to_dms_coords
...
def test_to_dms_coords():
    ...
    assert to_dms_coords([12.582222222222223, 1.0]) == "123456N 010000E"
    assert to_dms_coords([-12.582222222222223, -1.0]) == "123456S 010000W"
